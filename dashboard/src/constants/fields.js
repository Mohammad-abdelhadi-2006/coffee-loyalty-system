/* 
 * Configuration mapping object for touch keyboard behavior across all input fields.
 * Each key defines the title, default keyboard mode, and allowed mode toggles.
 */
export const FIELDS = {
    // ── Login ──
